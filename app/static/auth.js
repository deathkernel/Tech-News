(() => {
  ...
  editorialStyle.textContent = `
    .tech-news-auth{background:#f4f0e8 !important;color:#171717 !important;font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif !important}
    .tech-news-auth:before,.tech-news-auth:after{display:none !important}
    .tech-news-auth-box{width:min(760px,100%) !important;min-height:0 !important;grid-template-columns:1fr !important;border:1px solid #1d1d1d !important;border-radius:0 !important;background:#fbfaf6 !important;box-shadow:8px 8px 0 #1d1d1d !important}
    .tech-news-auth-box:before{content:"THE TECH EXPRESS" !important;right:18px !important;top:auto !important;bottom:14px !important;color:rgba(20,20,20,.06) !important;font-family:Georgia,"Times New Roman",serif !important;font-size:22px !important;font-weight:700 !important;transform:none !important;letter-spacing:.08em !important}
    .tech-news-auth-brand-panel{padding:34px 38px 28px !important;display:block !important;border-right:0 !important;border-bottom:1px solid #1d1d1d !important;background:#fbfaf6 !important}
    .tech-news-auth-brand-panel:before{display:none !important}
    .tech-news-auth-mark{color:#171717 !important;font-size:9px !important;letter-spacing:.16em !important}
    .tech-news-auth-mark i{width:28px !important;height:28px !important;border:1px solid #171717 !important;border-radius:0 !important;box-shadow:none !important;background:#171717 !important}
    .tech-news-auth-mark i:before,.tech-news-auth-mark i:after{display:none !important}
    .tech-news-auth-brand-panel h2{max-width:none !important;margin:30px 0 0 !important;color:#171717 !important;font-family:Georgia,"Times New Roman",serif !important;font-size:clamp(48px,8vw,72px) !important;font-weight:700 !important;line-height:.86 !important;letter-spacing:-.06em !important}
    .tech-news-auth-brand-panel h2 em{color:#171717 !important;font-family:Georgia,"Times New Roman",serif !important;font-weight:400 !important;font-style:italic !important}
    .tech-news-auth-brand-panel .brand-sub{margin:14px 0 0 !important;color:#68645d !important;font-size:8px !important;font-weight:800 !important;letter-spacing:.2em !important}
    .tech-news-auth-status{display:none !important}
    .tech-news-auth-form-panel{padding:34px 38px 40px !important;background:#fbfaf6 !important}
    .tech-news-auth-form{max-width:420px !important}
    .tech-news-auth-eyebrow{margin-bottom:14px !important;color:#6b675f !important;font-size:8px !important;letter-spacing:.18em !important}
    .tech-news-auth-eyebrow:after{background:#171717 !important;width:42px !important}
    .tech-news-auth-form h1{color:#171717 !important;font-family:Georgia,"Times New Roman",serif !important;font-size:34px !important;font-weight:700 !important;letter-spacing:-.035em !important}
    .tech-news-auth-form .sub{color:#68645d !important;font-size:11px !important;line-height:1.6 !important}
    .tech-news-auth-field{margin-top:16px !important}
    .tech-news-auth-field label{color:#55514a !important;font-size:8px !important;letter-spacing:.13em !important}
    .tech-news-auth-box input{height:46px !important;border:1px solid #aaa49a !important;border-radius:0 !important;background:#fffefa !important;color:#171717 !important;font-size:12px !important;box-shadow:none !important}
    .tech-news-auth-box input::placeholder{color:#99948b !important}
    .tech-news-auth-box input:focus{border-color:#171717 !important;background:#fffefa !important;box-shadow:0 0 0 2px rgba(23,23,23,.08) !important}
    .tech-news-auth-submit{height:46px !important;margin-top:22px !important;border:1px solid #171717 !important;border-radius:0 !important;background:#171717 !important;color:#fbfaf6 !important;box-shadow:none !important;font-size:9px !important;letter-spacing:.15em !important}
    .tech-news-auth-submit:hover{background:#333 !important;transform:none !important;box-shadow:none !important}
    .tech-news-auth-error{color:#9b2c24 !important}
    .tech-news-auth-switch{color:#68645d !important}
    .tech-news-auth-switch button{color:#171717 !important;text-decoration-color:#171717 !important}
    @media(max-width:760px){.tech-news-auth{padding:14px !important}.tech-news-auth-box{max-width:500px !important}.tech-news-auth-brand-panel{padding:28px 24px 24px !important}.tech-news-auth-brand-panel h2{font-size:46px !important}.tech-news-auth-form-panel{padding:28px 24px 32px !important}}
  `;
